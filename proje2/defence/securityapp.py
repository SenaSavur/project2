...
#  Antivirüs koruması (dictionary attack için)
from defense_dickattack import is_ip_blocked, register_failed_attempt
...
def login():
    ...
    if is_ip_blocked(client_ip):
        return jsonify({"success": False, "message": "Çok fazla başarısız giriş. Lütfen biraz bekleyin."}), 429
    ...
    #  Hatalı giriş olursa IP'yi kayıt altına al
